...
# 2. Call math(tool="plot_bar", arguments={...}): 24 months, currency with commas, value labels, plain-English months
...
BODY=$(jq -n --argjson args "$PLOT_ARGS" '{jsonrpc:"2.0",id:2,method:"tools/call",params:{name:"math",arguments:{tool:"plot_bar",arguments:$args}}}')
