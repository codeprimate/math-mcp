"""SymPy-based symbolic math tools."""
...
def register_sympy_tools(mcp):
    ...
    mcp.tool(name="solve")(tool_solve)
    mcp.tool(name="derivative")(tool_derivative)
    mcp.tool(name="integral")(tool_integral)
    mcp.tool(name="expand")(tool_expand)
    mcp.tool(name="factor")(tool_factor)
